...
const AboutusBar = () => {
  return (
    <div><div className="flex  justify-between items-center mx-20">
        <div className="flex p-2 gap-6  text-black  text-sm font-light">
          <div className="border-r-3 border-gray-400 pr-4">
            <LocationOnIcon fontSize="small" /> 123 Main Street ,Anytown, USA
          </div>
          <div className="flex ">
